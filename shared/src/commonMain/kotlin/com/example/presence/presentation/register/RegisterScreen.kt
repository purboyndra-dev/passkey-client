...
import com.example.presence.LoginRoute
...
fun RegisterScreen(
    ...
    LaunchedEffect(uisState) {
        if (uisState.success != null) {
            snackbarHostState
                .showSnackbar(
                    message = "Successfully create passkeys!",
                )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        "Sign Up", style = MaterialTheme.typography.headlineSmall.copy(
...
//                }
        ...
        LazyColumn(
            ...
            item {
                Text(
                    "Full Name", style = MaterialTheme.typography.labelLarge.copy(
                        fontWeight = FontWeight.SemiBold
                    )
                )
                ...
                BasicTextField(
                    ...
                    decorationBox = { innerTextField ->
                        Box(
                            ...
                            if (fullName.isBlank()) {
                                Text(
                                    text = "Enter full name", style = TextStyle(
